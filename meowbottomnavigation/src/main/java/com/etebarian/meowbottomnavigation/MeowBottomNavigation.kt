...
class MeowBottomNavigation : FrameLayout {
    ...
    private var myColor = Color.parseColor("#757575")
    private var selectedIconBackgroundColor = Color.parseColor("#757575")
    ...
    private fun setAttributeFromXml(context: Context, attrs: AttributeSet) {
        ...
        try {
            a?.apply {
                ...
                myColor = getColor(R.styleable.MeowBottomNavigation_mbn_selectedMyColor, myColor)

                selectedIconBackgroundColor = getColor(R.styleable.MeowBottomNavigation_mbn_selectedIconBackgroundColor, selectedIconBackgroundColor)
...
nexticon= model.nexticon
            ...
            myColor = this@MeowBottomNavigation.myColor
            selectedIconBackgroundColor = this@MeowBottomNavigation.selectedIconBackgroundColor
            setOnClickListener {
...
//                show(model.icon)
    ...
    fun changeIcon(id: Int, icon: Int) {
        val model = getModelById(id) ?: return
        val pos = getModelPosition(id)
        model.nexticon = icon
        cells[pos].nexticon =icon
    }
    ...
    class Model(var id: Int, var icon: Int,var nexticon: Int) {
