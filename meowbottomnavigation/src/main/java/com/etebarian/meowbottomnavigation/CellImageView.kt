...
//                nextresource = getResourceId(R.styleable.CellImageView_meow_imageview_nextresource, nextresource)
...
//        if (isBitmap) {
//            try {
//                val drawable = if (color == 0) context.getDrawableCompat(nextresource) else DrawableHelper.changeColorDrawableRes(context, nextresource, color)
//                setImageDrawable(drawable)
//            } catch (e: Exception) {
//                e.printStackTrace()
//            }
