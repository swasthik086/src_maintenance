...
//            ViewCompat.setElevation(v_circle, if (progress > 0.7f) dipf(context, progress * 4f) else 0f)
            ...
            if (Build.VERSION.SDK_INT >= 21 && isEnabledCell) {
                ...
                iv.setImageResource(nexticon);
//                d.shape = GradientDrawable.OVAL

                //  fl.setBackgroundColor(R.color.colorAccent);
    ...
    var isEnabledCell = false
        ...
        set(value) {
            ...
            if (Build.VERSION.SDK_INT >= 21 && !isEnabledCell) {
                ...
                d2.setColor(rippleColor)
                d2.shape = GradientDrawable.OVAL

                ViewCompat.setBackground(fl, d2)
                // ViewCompat.setBackground(v_circle, d2);
                iv.resource = nexticon;
                iv.setImageResource(nexticon);
//                fl.setBackgroundColor(Color.TRANSPARENT)

//                iv.setAlpha(0.5f);
                iv.setBackgroundResource(nexticon);   // **********
//                fl.setBackgroundColor(rippleColor);
