...
//        String[] deviceNames = bleScanRuleConfig.getDeviceNames();
        ...
        BleScanner.getInstance().scan(null, null, deviceMac, fuzzy, timeOut, callback);
    }
...
//        String[] deviceNames = bleScanRuleConfig.getDeviceNames();
        ...
        BleScanner.getInstance().scanAndConnect(null, null, deviceMac, fuzzy, timeOut, callback);
    }
     ...
     * @return
     */
    public BluetoothGatt connect(BleDevice bleDevice, boolean autoconnect, BleGattCallback bleGattCallback) {
...
//            boolean autoConnect = true;
            return bleBluetooth.connect(bleDevice, true, bleGattCallback);
        }
     ...
     * @return
     */
    public BluetoothGatt connect(String mac, boolean autoconnect, BleGattCallback bleGattCallback) {
        ...
        return connect(bleDevice, autoconnect, bleGattCallback);
    ...
    public void write(BleDevice bleDevice,
        ...
        write(bleDevice, uuid_service, uuid_write, data, false, callback);
    }
    ...
    public void write(BleDevice bleDevice,
        ...
        BleBluetooth bleBluetooth = multipleBluetoothController.getBleBluetooth(bleDevice);
        if (bleBluetooth == null) {
            BleLog.w("When bleBluetooth == null");
