...
//private static final String UUID_CLIENT_CHARACTERISTIC_CONFIG_DESCRIPTOR="0000D105-0000-1000-8002-0002C7000000";
     ...
     * notify setting
     */
    private boolean setCharacteristicNotification(final BluetoothGatt gatt,
...
//                @Override
//                public void run() {
//                    boolean success22 = gatt.writeDescriptor(descriptor);
//                    Log.d("mGattCallback250250", "--" +success22);
//                }
//            },500);
//            Log.d("mGattCallback250", "--" +success2);
//            if (!success2) {
//                notifyMsgInit();
//                if (bleNotifyCallback != null)
//                    bleNotifyCallback.onNotifyFailure(new OtherException("gatt writeDescriptor fail"));
//                Log.d("mGattCallback51", "--" +51);
//            }
//            return success2;
            return true;
        }
